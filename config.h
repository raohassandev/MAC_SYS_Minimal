...
// Hardware Configuration - KC868-A6 Board (Corrected)
...
// PCF8574 I2C Addresses - KC868-A6 Standard
#define PCF8574_OUTPUT_ADDR 0x24  // Relay outputs (KC868-A6 standard)
#define PCF8574_INPUT_ADDR  0x22  // Digital inputs (KC868-A6 standard)
